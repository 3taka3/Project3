...
db.createCollection("loyals_customers","current_customers");
print("Collections create");

db.loyals_customers.insertMany([
...
db.current_customers.insertMany([
...
mongo.loyals_customers.find().forEach(printjson);
print("Data in current_customers:");
mongo.currents_customers.find().forEach(printjson);
